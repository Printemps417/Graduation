(function (global, factory) {
  ...
  function arrayFrom$1(arrayLike, mapFn) {
    ...
    var len = toLength$2(items.length); // 13. If IsConstructor(C) is true, then
  ...
  objectGetOwnPropertyDescriptor.f = DESCRIPTORS$a ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
    ...
    if (hasOwn$9(O, P)) return createPropertyDescriptor$4(!propertyIsEnumerableModule$2.f.call(O, P), O[P]);
  };
  ...
  */
  ...
  var lengthOfArrayLike$6 = function lengthOfArrayLike(obj) {
  ...
  var defineWellKnownSymbol$l = function defineWellKnownSymbol(NAME) {
    ...
    if (!hasOwn$1(Symbol, NAME)) defineProperty$4(Symbol, NAME, {
